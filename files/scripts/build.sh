...
curl -sSL https://dl.google.com/linux/direct/google-chrome-stable_current_x86_64.rpm -o google-chrome-stable_current_x86_64.rpm && rpm-ostree install ./google-chrome-stable_current_x86_64.rpm
